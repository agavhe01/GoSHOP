...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware',             # 1: handle CORS headers
    'django.middleware.security.SecurityMiddleware',     # 2: Security + WhiteNoise
...
# allows anyone to make api calls
